...
import {managedDefaultsAsOptions} from './nassh_managed_policy.js';
...
export function postProcessOptions(options, hostname, username, isMount) {
  ...
  // Apply enterprise-managed defaults (chrome.storage.managed) before named
  // configs or fallback logic. The user's explicit options still win because
  // `rv` is the second argument to Object.assign.
  rv = Object.assign({}, managedDefaultsAsOptions(), rv);
